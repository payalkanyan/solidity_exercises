...
contract Tupledore {
   ...
   function setTuple(address newAddress, uint256 _newUser) public {
      userInfo._address = newAddress;
      userInfo._user = _newUser;
      }

   function returnTuple() public view returns (address, uint256) {
        return (userInfo._address, userInfo._user);
    }
}
